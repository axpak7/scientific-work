...
n = [1048576 524288 262144 131072 65536 32768 16384 8192 4096 2048 1024 512 256 128 64 32 16 8 4 2];
x_start = 0;
x_end = 1;
...
for i = 1:20
    E1(i) = norm(structural_method2(f, x_start, x_end, y0, n(i), 0, 2, 2)' - solution(x_end),Inf);
    E2(i) = norm(sophisticated_structural_method2(f, x_start, x_end, y0, n(i), 0, 2, 2)' - solution(x_end),Inf);
    disp(i);
end
%E2(E2 == 0) = min(E2(E2 ~= 0));
