...
for i = 1:24
    E1(i) = abs(runge_kutta2(x_start,x_end,n(i)) - solution(x_end));
    E2(i) = abs(sophisticated_runge_kutta2(x_start,x_end,n(i)) - solution(x_end));
end
E2(E2 == 0) = min(E2(E2 ~= 0));
...
hold on;
loglog(h,E2,'-o');
title('2-order Runge-Kutta method for the equation');
xlabel('h');
ylabel('|E|');
hold off;