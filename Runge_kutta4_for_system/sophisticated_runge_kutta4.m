...
for i = 1:n
    ...
    term1 = h*(b1*k11+b2*k21+b3*k31+b4*k41) + z(1);
    term2 = h*(b1*k12+b2*k22+b3*k32+b4*k42) + z(2);
    term3 = h*(b1*k13+b2*k23+b3*k33+b4*k43) + z(3);
    term4 = h*(b1*k14+b2*k24+b3*k34+b4*k44) + z(4);
    newy1 = y1(i) + term1;
    newy2 = y2(i) + term2;
    newy3 = y3(i) + term3;
    newy4 = y4(i) + term4;
